...
export const sites: Site[] = [
  ...
  { key: "management", slug: "management-note", brand: "Management Notes", label: "管理", ns: "mgt", kind: "humanities" },
  { key: "problem-solving", slug: "problem-solving-note", brand: "Problem-Solving Notes", label: "問題解決", ns: "psv", kind: "humanities" },
  { key: "science", slug: "science-note", brand: "Science Notes", label: "科學", ns: "sci", kind: "humanities" },
  { key: "hbr", slug: "hbr-note", brand: "HBR Notes", label: "哈佛商業評論", ns: "hbr", kind: "humanities" },
  { key: "nouwen", slug: "nouwen-note", brand: "Nouwen Notes", label: "盧雲", ns: "nvn", kind: "humanities" },
  { key: "willard", slug: "willard-note", brand: "Dallas Willard Notes", label: "魏樂德", ns: "dwl", kind: "humanities" },
  { key: "kiyosaki", slug: "kiyosaki-note", brand: "Kiyosaki Notes", label: "清崎", ns: "kyk", kind: "humanities" },
  { key: "newport", slug: "newport-note", brand: "Cal Newport Notes", label: "紐波特", ns: "cnp", kind: "humanities" },
  { key: "liurun", slug: "liurun-note", brand: "Liu Run Notes", label: "劉潤", ns: "lrn", kind: "humanities" },
  { key: "fengtang", slug: "fengtang-note", brand: "Feng Tang Notes", label: "馮唐", ns: "ftg", kind: "humanities" },
  { key: "gardner", slug: "gardner-note", brand: "Howard Gardner Notes", label: "加德納", ns: "hgd", kind: "humanities" },
  { key: "taleb", slug: "taleb-note", brand: "Taleb Notes", label: "塔雷伯", ns: "tlb", kind: "humanities" },
