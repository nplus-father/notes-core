...
> **未清的溯源債（2026-08-04 掃出）**:上表三站「新增」的頁都掛了 anchor,但**開站當天的種子概念沒有**——用 `note-enrich` §0.5 的掃描跑出來是 agile 4 頁、covey 6 頁、design 3 頁,數字正好等於各站的開站種子數。處置與 templar/navarro 相同:回原文逐段核對後改寫,不是補 anchor 了事。**排在下一輪的第一位。**
