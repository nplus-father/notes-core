...
兩站各五章＋overview 接線＋build 綠＋dist 死鏈 0＋稽核六欄 0。

**personal-finance（40 本、36 頁）**：三問（夠的定義／省與賺兩條腿／心態與系統）＋暗線
「收入幻覺」；六卡收成三場對話（速度／終點／引擎），富爸爸卡判外包型（6 本歸 kiyosaki）；
豁免率 48% 判「理財星系的門廳」——投資技術歸 investing、現金流哲學歸 kiyosaki，本站守
夠的定義／儲蓄率／自動化／花錢品質。四官司的判決都反直覺地溫和：拿鐵因子兩造在原文裡
幾乎和解（漫畫版互打是後人的簡化）、Ramsey 當庭承認數學不最佳仍勝訴、4% 是機率不是保單、
累積與花掉量的是同一條人生的兩個刻度。**fork 抓到指揮層兩筆錯**：support 實為 10 本
非派單寫的 11（21+10+1+8=40 才對帳）；Sabatier「七年」實為「五年多、30 歲達成」。
ch1 收稿補掛 Financial Freedom ch02 anchor（fork 自己點名的越界觀察）、「65 歲後兌現」
引句三章重複收斂成 ch2 全文＋ch1/ch4 轉述。

**life-meaning（39 本、34 頁）**：暗線「幸福＝感覺好」；六卡判**一疊樓層**（身心=硬體、
情緒=感測器、韌性=作業系統、正向心理學=調校層、意義=應用層、有限性=時鐘）——對齊型的
新變奏；意義治療卡判名冊變奏：**十本正典十個去處**（Frankl→wellness、心流／四千個
禮拜→tools、象與騎象人／阿德勒／EQ→thinking、第二座山→relationships、心靈地圖→peck、
Grit→career、Outlive→wellness），「名氣讓出去、承重留下來」。四官司：漢堡模型裁掉兩造／
樂觀與警戒判不同層／態度是自變數關係是環境變數／能量派勝訴但時間派只是降級。
**書本位紀律接住指揮層一筆**：哈佛研究書源一律「超過 84 年」，派單與 bibliography note
寫 85——三個 fork 獨立回源都抓到，note 已同步修正。招牌引句（Waldinger 句點句、Morrie
學會死）各重複 3–4 次，收斂成各兩處全文、其餘轉述。
...
量產不稀釋、**吳軍三線並行（史詩／數學／人生）幾乎不交叉，每本書各佔一個題目**。

- 01 「履歷表像三個人的」立像；「一流工程師寫通識」判市面科普的結構性弱點——「寫的人
  沒做過」，而他沒有這層隔；「他給的不是雞湯，是刻度」
- 02 六條貢獻收成「**一個上限、五種拉高它的方式**」；兩支透鏡的判讀漂亮——「他的預言
  不是嗅出來的，是從資訊論與成本結構推出來的」
- 03 「skip 專欄、收結集是版本裁決不是取捨」；《具體生活》的 skip 判「劃出本站邊界：
  收吳軍的思想，不收吳軍的全部」；17 spine 對 17 頁正好一本一頁
- 04 倖存者批評判兩半——「他給見識開的處方不是機票，是書：**一個真正把見識綁定在財富
  位置上的人，不會花二十年寫文明史給大眾讀**」；量化癖判「這一箭射中的是讀者，多過射中
  作者——他自己在書裡裝了平衡器」＋誠實邊界「大勢輾過小我的時刻，他的框架只能告訴你
  站錯了位置，安慰不了你——這裡沒有藥」；時代印記判「案例過期是基因決定定理的一次
  自我應驗」
- 05 「按你缺的透鏡挑線——工程師從見識進場會嫌雞湯，文科讀者從計算之魂進場會直接陣亡」；
  得到三學院對讀（吳軍長鏡頭、萬維鋼顯微鏡、劉潤翻譯機）

驗證：dist 相對連結 17 條 0 壞（正好覆蓋全站 17 頁）、tier-audit 六欄全 0（豁免率 6%）、
build／format／check 全綠。

**導覽補齊輪的可直接做佇列至此清空**——26 站連打（career 起）、全星系 69/75 站有導覽。
剩 6 站：4 站照 GUIDE-QUEUE 判準**先 enrich 再 guide**（cloud 9、gardner 8、fengtang 8、
pastoral-psychology 5——最後一站另有 5 頁未溯源債）；leetcode 無書單不在流程；
humanities 若有新站再入列。下一步的分工：**enrich 開單是 Fable 的活（選題），起草是
Opus 的活**——Andrew 已預告要切 Opus 接手。

## 導覽補齊輪・第二十五站（2026-08-27 Fable）——**newport-note 五章導覽完工**

8 本、10 頁（1.25 頁/書）。全弧線作者的樣本：「**按出版年讀，就是按邏輯讀**」——學生→
職涯→科技與社會，命題從沒換過。

- 01 兩個「沒有」立像（沒有社群帳號的暢銷作家＋沒有全職作家身分的教授）——「**他書裡的
  每一條主張，他自己先活過**」；假說式寫作判「他的書可以被證明是錯的，而多數勵志書連錯的
  資格都沒有」
- 02 五條貢獻收成「**一個資本、四條戰線**」（價值論／生產論／防禦論／節奏論）；四種深度
  哲學的共同點「決策前置——臨場對抗分心必敗」；金句「上班守不住是生產力問題，下班守不住
  是人生品質問題」「把注意力當資本管理，而不是當廢氣排放」
- 03 兩本學生 support 判「**概念的化石層**」（「偽工作」十年後放大成 Deep Work 的判詞）；
  收口「小而勻稱：沒有裝飾品，也沒有還沒開鏟的正典」
- 04 特權批評判「對準處方的適用範圍，沒推翻診斷」＋用站內公地悲劇段作證他自己接了這一拳，
  並誠實補「他的書裡沒有輪班者的章節，這個缺口如實掛著」；社群立場判「**他的原則比他的
  結論更耐用**」；AI 時代變數點為「全站最值得下一輪回訪的一頁」
- 05 讀序警告「跳過深度職場力直接讀 Deep Work——深度工作很容易被練成新的自我壓榨」；
  收尾「合上書，去過一天沒有收件匣的下午」

驗證：dist 相對連結 10 條 0 壞（正好覆蓋全站 10 頁）、tier-audit 六欄全 0、
build／format／check 全綠。

**剩 6 站**：可直接做 wujun 17（已預載）；先 enrich 再 guide 四站（cloud 9、gardner 8、
fengtang 8、pastoral-psychology 5）＋leetcode（不在流程）

## 導覽補齊輪・第二十四站（2026-08-27 Fable）——**fromm-note 五章導覽完工**

16 本、15 頁（0.94 頁/書）。滿編站的第二種理由在這站立住：schwager 是「一人書架沒有
裝飾品」，佛洛姆是「**量產而不稀釋——每一本真的在處理一個別本沒處理的問題**」。

- 01 開場「常被放在心理勵志那一櫃——站上讀完浮出來的是用診療室的工具解剖整個社會的
  批判理論家」；三個出身印記（先知傳統的倫理熱度／法蘭克福學派的結構分析／臨床的深度）
  判「這個焊接是他在思想史上獨一無二的位置」
- 02 六條貢獻收成「**一個診斷、四張處方、一份病理報告**」；四張處方判「其實是同一張：
  與世界重新聯結而不失去自我，那條窄路的四種走法」；連宗教與夢都拿同一把尺量
  （「它讓人更臣服，還是更有能力愛」）
- 03 自由三部曲寫成「同一場手術的三個階段」；《愛的藝術》判「**可能是二十世紀最被誤買的
  書之一**——書名像戀愛指南，內容是存在哲學；單獨讀是格言，接上三部曲才是論證」；
  《你們要像神一樣》判「最想收而收不到——缺了它宗教組只有批判的一半」；四筆 skip 判
  「不是品質判決，是體裁判決」
- 04 兩邊不討好判「**正是他的位置，不是他的失敗**」＋「指控他溫情的人，多半沒有讀過那
  七百頁對惡的解剖」；規範性人性論判「讀對類別，批評就換了對象」；暢銷的代價判成讀法
  ——雞湯化的閱讀「恰恰是市場型取向的完美示範：連他的書都被當成人格市場上的自我投資」
- 05 「從愛的藝術進場沒有問題，問題出在停在那裡」；冷戰印記收「陣營散了，尺還在——
  他量社會的尺是人性，不是意識形態」

驗證：dist 相對連結 15 條 0 壞（正好覆蓋全站 15 頁）、tier-audit 六欄全 0（豁免率 6%）、
build／format／check 全綠。

**剩 7 站**：可直接做 newport 10、wujun 17（兩站已預載）；先 enrich 再 guide 四站
（cloud 9、gardner 8、fengtang 8、pastoral-psychology 5）＋leetcode-note（無書單、
本來就不在導覽流程）
