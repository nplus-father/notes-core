...
- BST 剩餘：52 冊裡 20 卷已逐本列出（14＋本輪 6）、Stott 6 卷在 stott-note，**還有 26 卷**未立頁
  （馬太、馬可、利未記、列王紀、耶利米、以西結、但以理、箴言、路得、以斯帖、雅歌、小先知書群、
  哥林多前後、歌羅西腓利門、約翰書信、彼得前後書猶大書等）——同一條框架可續批。
...
| 站 | pages/owned |
|---|---|
| biblical-studies-note | 44 / 74(批次 1+2 完成 2026-08-06:批次 1 補列 14 本 BST 並寫 14 頁卷冊解經框架;批次 2 再寫 11 頁清高價值缺口——Beale 新創造、賴特卷一史學方法、Bailey 中東之眼、Waltke toledot、Hays 三焦點、Ehrman 文本鑑別、逐卷讀經法/難解經文/孫寶玲講道學、Watkin 對角化、Peterson lectio divina。**批次 3 完成 2026-08-26**:再補列 6 卷、各寫一頁(約書亞/撒母耳/約伯/傳道書/以賽亞/約翰福音),站況 57 頁 81 本;Stott 那 6 卷確認歸 stott-note 不重寫。**批次 4+ 剩餘**:BST 還有 26 卷(馬太、馬可、利未記、列王紀、耶利米、以西結、但以理、箴言、路得、以斯帖、雅歌、小先知書群、哥林多前後、歌羅西腓利門、約翰書信、彼得前後書猶大書等,同框架可續批);工具書群(TDNT/IVP 背景註釋等)作 alternative 不立頁) |
