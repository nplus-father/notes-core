...
| 站 | 型 | owned | 頁 | 頁/書 | enriched | 備註 |
| --- | --- | ---: | ---: | ---: | --- | --- |
| cloud-note | 人物 | 13 | 15 | 1.2 | 2026-08-27 | 深化完成（連結／分辨善惡／信任修復三頁）；人物站門檻已過 |
| gardner-note | 人物 | 13 | 13 | 1.0 | 2026-08-27 | 深化完成（八項判準／學徒制與學校）；multiple-intelligences 分類補厚 |
| fengtang-note | 人物 | 10 | 12 | 1.2 | 2026-08-27 | 深化完成（好習慣／曾國藩日記／漢初守成）；management 分類補厚、《成事》首次有承載頁 |
| pastoral-psychology-note | 主題 | 5 | 8 | 1.6 | 2026-08-27 | 深化完成（懼怕人解方／依附三型／羞恥解藥）；主題站仍偏薄，導覽要誠實寫「書架只有 5 本」 |
