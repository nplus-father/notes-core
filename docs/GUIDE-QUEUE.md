...
| 站 | 型 | owned | 頁 | 頁/書 | enriched | 備註 |
| --- | --- | ---: | ---: | ---: | --- | --- |
| life-meaning-note | 主題 | 39 | 34 | 0.87 | — | **導覽輪漏接的一站**——條件早就足（主題站 ≥30 頁），一直沒被領走 |
| personal-finance-note | 主題 | 40 | 36 | 0.90 | — | **書端卡點已解除**（automatic-millionaire 深度概覽 2026-08-28 實測 PASS、0 空葉），可直接做 |
