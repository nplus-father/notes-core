...
| business-strategy-note | 主題 | 50 | 38 | 0.78 | 2026-08-26 | writtenAt 2026-08-27；暗線「策略≠雄心」；權力卡判寄居型（孫子＝最老那面牆）；護城河與死因官司（Helmer 反向定位＝框架派自我收編）；delegated 31% 全星系之最判「十字路口中樞」；交會點「策略是一連串的不」 |
...
| kiyosaki-note | 人物 | 23 | 14 | 0.6 | 2026-08-06 | writtenAt 2026-08-27；主線「六次重定義——他改的是字典」；讀法「把財務教育的清崎與宏觀預言的清崎拆成兩個人」；預言帳「裂縫是真的、地震時刻從來不準」；破產帳第二層最冷（有限責任用得很徹底包括對債權人）；定位「啟蒙者不是理財顧問——讀他換腦別抄單」 |
| liurun-note | 人物 | 12 | 13 | 1.1 | — | writtenAt 2026-08-27；主線「一條公式四次代入——他其實只寫了一條公式」；轉譯批評判「翻譯得夠好本身就是原創——劉潤是入口不是圖書館」；案例時效判「公式比案例耐久，而且是他自己的公式預言的」；年度演講爭議判「體裁的物理不是道德問題」 |
| fromm-note | 人物 | 16 | 15 | 0.94 | — | writtenAt 2026-08-27；主線「一個診斷四張處方一份病理報告」；滿編判「量產而不稀釋——每本處理一個別本沒處理的問題」；愛的藝術判「二十世紀最被誤買的書之一」；兩邊不討好判「正是他的位置不是失敗」；讀法「讀愛的藝術要帶著逃避自由」 |
| newport-note | 人物 | 8 | 10 | 1.25 | — | writtenAt 2026-08-27；主線「一個資本四條戰線」；兩個「沒有」立像（每條主張他自己先活過）；假說式寫作判「他的書可以被證明是錯的，多數勵志書連錯的資格都沒有」；書目「按出版年讀就是按邏輯讀」；特權批評判「對準處方沒推翻診斷」 |
| wujun-note | 人物 | 18 | 17 | 0.94 | — | writtenAt 2026-08-27；主線「一個上限五種拉高它的方式」；近滿編第三種理由「三線並行幾乎不交叉」；倖存者批評判「處方不是機票是書」；量化癖判「射中讀者多過作者——他自己裝了平衡器」；讀法「按你缺的透鏡挑線」 |
| personal-finance-note | 主題 | 40 | 36 | 0.90 | — | writtenAt 2026-08-28；三問一暗線（共同敵人=收入幻覺）；四官司判決溫和（原文幾乎和解/當庭認罪仍勝訴）；豁免率 48% 判「理財星系的門廳」；富爸爸卡外包 kiyosaki |
| life-meaning-note | 主題 | 39 | 34 | 0.87 | — | writtenAt 2026-08-28；暗線「幸福≠感覺好」；六卡判一疊樓層；意義治療卡=名冊變奏（十本正典十個去處）；哈佛研究 84 年照書源正名（bibliography note 同步修） |
| cloud-note | 人物 | 13 | 15 | 1.2 | — | writtenAt 2026-08-28；主線「一條產權線四個尺度」；切割文化判「引用他的詞彙、違反他的文法」；讀法判「理論排第三——框架書要有痛感才讀得進」；《成長神學》spine 無專屬頁記為最該先還的帳 |
| gardner-note | 人物 | 13 | 13 | 1.0 | — | writtenAt 2026-08-28；主線「先弄清心智是什麼，再問它為誰所用」；爭議判「傷理論最深的是教室裡的盟友」；道德／情緒智能否決判「判準不是橡皮圖章」；站內「25 年」錯數照書源修為十六年（bibliography／profile／概念頁同步） |
| fengtang-note | 人物 | 10 | 12 | 1.2 | — | writtenAt 2026-08-28；主線「一體一用一鑑一魂」；文學判「成事學的防腐劑——抽掉它九字箴言退化成厚黑學」；成功學指控判「界線可檢驗但證據結構是倖存者自述」；金線定義照書源正名「以事實為基礎」 |
| pastoral-psychology-note | 主題 | 5 | 8 | 1.6 | — | writtenAt 2026-08-28；封閉書單站 5/10 誠實入章；光譜判「兩端有原文、中三家懸空」；共識判「兩端同開一張藥方」；REACH 五步由 McMinn 轉述接住（概念頁還債補 anchor）；下一步在收書端不在寫作端 |
...
2026-08-28 Fable 把末四站（cloud／gardner／fengtang／pastoral-psychology）全數完工，本節清空——**收書歸零的站導覽全數到位**（唯 leetcode-note 不在流水線內：自維護前端、無 bibliography）。
...
2026-08-27 Opus 已把四站的 11 筆深化單全部交付（詳帳在 ENRICH-BACKLOG），本節清空。

| 站 | 型 | owned | 頁 | 頁/書 | enriched | 備註 |
| --- | --- | ---: | ---: | ---: | --- | --- |
（本節已清空——四站深化完成，見下方「可做」表）
