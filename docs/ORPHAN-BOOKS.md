...
> **生成於 2026-08-28T01:16:02+08:00**｜由 `tools/export-orphan-books.py` 產生，**不要手改**——改資料源再重跑。
...
| `commentary` | theology | 2/59 | 3% | biblical-studies(52)、stott(6) |
...
#### `commentary` — 2/59 沒人認領（目前：biblical-studies(52)、stott(6)）
