...
> **生成於 2026-08-26T11:45:34+08:00**｜由 `tools/export-orphan-books.py` 產生，**不要手改**——改資料源再重跑。
...
| 檢查 | 數 | 後果 |
| --- | ---: | --- |
| 孤兒書（沒有任何站的 bibliography 指到） | **348** | 書站建了但沒有筆記在用，等於白建 |
...
| `commentary` | theology | 22/59 | 37% | biblical-studies(32)、stott(6) |
...
#### `commentary` — 22/59 沒人認領（目前：biblical-studies(32)、stott(6)）
