...
> **生成於 2026-08-26T18:28:17+08:00**｜由 `tools/export-year-conflicts.py` 產生，**不要手改**——改資料源再重跑。
...
| --- | ---: | --- |
| 有 slug 的條目 | 1925 | — |
| **跨站 year 矛盾** | **14** | 同一本書在年代圖上出現在兩個年代 |
...
- **1968** — biblical-studies-note（聖經信息系列（The Message of …，全 52 冊））
- **1994** — stott-note（羅馬書的信息）
