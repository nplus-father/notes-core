...
> **生成於 2026-09-03T00:41:36+08:00**｜由 `tools/export-year-conflicts.py` 產生，**不要手改**——改資料源再重跑。
...
| **year 晚於書 repo 的 published** | **1** | 填的是某個改版年，不是初版年 |
...
## 五、`year` 晚於書 repo 的 `published`：1 本
