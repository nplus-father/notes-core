...
> **生成於 2026-09-03T00:42:03+08:00**｜由 `tools/export-guide-drift.py` 產生，**不要手改**——改資料源再重跑。
...
- 弱訊號：36 筆——光禿禿的「站上 N 頁」，**多數其實是子集宣稱**（「站上三頁以它為主引」＝有三頁引用這本書，不是站台總共三頁），列出來供抽查，不是判決。
