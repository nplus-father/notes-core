...
TOP20 = [
    ...
    ("the-everlasting-man", "portal 只有 2 本切斯特頓（Orthodoxy、What's Wrong with the World）；「切斯特頓」站內 11 處、跨 3 站（lewis、theology、design），而 portal 13 本路易斯那整個書櫃的歸信轉捩點正是這一本——收了才接得起來；薄、有繁中《永恆的人》"),
    ...
    ("trading-in-the-zone", "portal 已有 Mark Douglas 的前作 The Disciplined Trader，缺這本被當成交易心理標準讀物的成熟之作——「交易心理」站內 12 處，橫跨 investing 與 schwager 兩站，兩站的概念頁都指著它；investing 站 owned 54／wanted 8"),
    ...
    ("advanced-selling-strategies", "portal 已有 34 本 Brian Tracy——**全星系最深的作者書櫃**，而 tracy 站 owned 34／wanted 2；銷售線上已有 The Psychology of Selling、Sales Management、Negotiation 三本，缺的正是大客戶與關係銷售這一層進階正典（「銷售」全星系 298 處、113 個檔案、31 站）"),
    ...
    ("the-body-keeps-the-score", "「創傷」是全星系橫跨最廣的概念之一——38 處、20 個檔案、**10 站**（growth、history、life-meaning、navarro、peterson、relationships、taleb、theology、thinking、wellness），而 portal 的 van der Kolk **掛零**，這片引用沒有任何原典可掛；有繁中《心靈的傷，身體會記住》，厚，排中後段"),
